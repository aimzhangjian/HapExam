//package hapExam.aimcore.db

import com.hand.hap.liquibase.MigrationHelper

//表结构
databaseChangeLog(logicalFilePath: "hapExam/aimcore/db/liquibase.groovy") {
    ...
    migrationHelper.dbmigrate("mysql",["com/hand/hap","hapExam/aimcore"] ,["table", "data"])
